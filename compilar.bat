...
echo Compilando los archivos y guardando en directortio de salida...
javac -cp "%CLASSPATH%" -d %SALIDA% %SRC%

rem Paso 3. Crear archivo JAR
echo Creando archivo MANIFEST al vuelo y guardando archivo jar en directorio de salida...
